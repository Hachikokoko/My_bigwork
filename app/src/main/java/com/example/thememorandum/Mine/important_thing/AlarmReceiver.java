...
public class AlarmReceiver extends WakefulBroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (frequency > 0) {
            ...
            Intent setAlarm = new Intent(context, AlarmService02.class);
            setAlarm.putExtra(ReminderParams.ID, id);
            setAlarm.setAction(AlarmService02.CREATE);
            context.startService(setAlarm);
        }

        Intent result = new Intent(context, important_thing.class);
        ...
        Notification n = new NotificationCompat.Builder(context)
                .setSmallIcon(R.mipmap.ic_calendar_check_black_48dp)
